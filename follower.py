...
class VOXLFollower(Node):
    def __init__(self):
        ...
        self.img_w = int(input("Enter image width in pixels: ").strip())
        self.img_h = int(input("Enter image height in pixels: ").strip())

        # --- control gains & state ---
        self.K_LAT  = 0.1    # east gain
        self.K_FWD  = 0.1    # north gain (based on area)
